...
Q_SIGNALS:
    ...
    void connectionDisconnected(const QString &peerId);

	void connectionFailed(const QString &peerId);

	void incomingPacket(const QString &peerId, const QByteArray &data);
